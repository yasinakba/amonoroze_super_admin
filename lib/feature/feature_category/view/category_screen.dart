                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Padding(padding: EdgeInsets.all(12),child: IconButton(onPressed: () {
                                showCustomDialog(context: context,onYesPressed: () => controller.deleteCategory(id: category.id,context: context), text: 'Do you want delete', objectName: category.title??'');
